(function () {
 ...
 // let menuname1 = document.getElementById("menuname1");
 // let menuname2 = document.getElementById("menuname2");
 // let menuname3 = document.getElementById("menuname3");

 // menuButton.addEventListener("click", function (e) {
 //   e.preventDefault();
 //   console.log(menuname1.style.display);
 //   if (menuname1.style.display === "none") {
 //     menuname1.style.display === "flex";
 //     menuname2.style.display === "flex";
 //     menuname3.style.display === "flex";
 //   } else {
